<div class="w-full md:w-64 bg-white rounded-lg shadow-md p-4 h-fit">
    ...
    <nav class="space-y-1">
        ...
        <a href="{{ route('panel.advertisement.create') }}" class="sidebar-item flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $active == 'post-job' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
